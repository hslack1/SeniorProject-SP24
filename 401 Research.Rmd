...
# Assuming lm_model is your linear regression model object
# Assuming "group" is the categorical predictor variable with multiple levels in lm_model

# Load the emmeans package (if not already installed)
confint(lm_model)

# Assuming lm_model is your multiple linear regression model object
